      ...
      <div class="d-flex">
        ...
        background: rgba(49, 46, 50, 0.85); opacity:0.9px;">
            <div class="nav flex-column nav-pills me-3 text" id="v-pills-tab" role="tablist" aria-orientation="vertical">
              <a class="nav-link" href="tampilan.php">Home</a>
                  ...
                  <tbody class="table-group-divider">
                    <?php  
                      while($user_data = mysqli_fetch_array($result)) {         
                          ...
                          echo "<td><a href='terima.php?id_pengaduan=$user_data[id_pengaduan]' class='btn btn-secondary '>Terima</a> 
                          <a href='selesai.php?id_pengaduan=$user_data[id_pengaduan]' class='btn btn-success '>Selesai</a> 
                          <a href='delete.php?id_pengaduan=$user_data[id_pengaduan]'class='btn btn-danger'>Tolak</a>
                          <a href='tanggapan.php?id_pengaduan=$user_data[id_pengaduan]'class='btn btn-primary'>Tanggapan</a>
                           </td></tr>";
                        }
                      ?>
                    </tbody>
